...
const EBF_COIL_REQUIREMENTS = [
  { heat: 1801, key: "cupronickel", label: "Cupronickel", colors: ["#b87953", "#e0b084"] },
  { heat: 2701, key: "kanthal", label: "Kanthal", colors: ["#b77b37", "#f3c362"] },
  { heat: 3601, key: "nichrome", label: "Nichrome", colors: ["#b9b9c4", "#f0d6d6"] },
  { heat: 4501, key: "tpv", label: "TPV", colors: ["#4e687b", "#9dc5de"] },
  { heat: 5401, key: "hss_g", label: "HSS-G", colors: ["#5d7881", "#b8e3eb"] },
  { heat: 6301, key: "hss_s", label: "HSS-S", colors: ["#8a6f9d", "#dcc3f5"] },
  { heat: 7201, key: "naquadah", label: "Naquadah", colors: ["#2d5d43", "#69c48d"] },
  { heat: 8101, key: "naquadah_alloy", label: "Naquadah Alloy", colors: ["#355956", "#7dd7c5"] },
  { heat: 9001, key: "trinium", label: "Trinium", colors: ["#6c5f72", "#cdb9d6"] },
  { heat: 9901, key: "electrum_flux", label: "Electrum Flux", colors: ["#966a1d", "#ffe36b"] },
  { heat: 10801, key: "awakened_draconium", label: "Awakened Draconium", colors: ["#b85a23", "#ff9a3d"] },
  { heat: 11701, key: "infinity", label: "Infinity", colors: ["#5f5f72", "#ffffff"] },
  { heat: 12601, key: "hypogen", label: "Hypogen", colors: ["#43315c", "#d278ff"] },
  { heat: 13501, key: "eternal", label: "Eternal", colors: ["#222222", "#f6f3ff"] },
] as const;
...
function makeCoilRequirementInput(
  ...
  return {
    kind: "item",
    id: `gtnh:requirement/coil/${coil.key}`,
    amount: 1,
    displayName: `${coil.label} Coils`,
