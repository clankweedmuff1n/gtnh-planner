...
exporterSource = exporterSource.replace(
  ...
  [
    ...
    "            TemplateRecipeHandler handler = (TemplateRecipeHandler) rawHandler;",
    "            String recipeName = handler.getRecipeName();",
    "            if (!isPassiveNeiRecipeHandler(recipeName)) {",
    "                continue;",
    "            }",
    "",
    "            List<Map<String, Object>> recipes = exportPassiveNeiHandlerRecipes(handler);",
    "            if (recipes.isEmpty()) {",
    "                continue;",
    "            }",
    "",
    ...
    "    }",
    "",
    "    private static boolean isPassiveNeiRecipeHandler(String recipeName) {",
    "        if (recipeName == null) {",
    "            return false;",
    "        }",
    "",
    "        String normalized = EnumChatFormatting.getTextWithoutFormattingCodes(recipeName).toLowerCase();",
    ...
    "    }",
    "",
    "    private static List<Map<String, Object>> exportPassiveNeiHandlerRecipes(TemplateRecipeHandler handler) {",
    ...
    "        }",
    "",
    '        loadPassiveNeiRecipes(instance, callStringMethod(handler, "getOverlayIdentifier"));',
    "        loadPassiveNeiRecipes(instance, handler.getRecipeName());",
    "",
    ...
    "    }",
    "",
    "    private static void loadPassiveNeiRecipes(TemplateRecipeHandler handler, String outputId) {",
